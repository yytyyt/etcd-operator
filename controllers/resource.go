...
import (
	"github.com/yytyyt/etcd-operator/api/v1alpha1"
...
// MutateHeadlessSvc 根据EtcdCluster组装Service
func MutateHeadlessSvc(etcdCluster *v1alpha1.EtcdCluster, svc *corev1.Service) {
...
// MutateStatefulSet 根据EtcdCluster组装StatefulSet
func MutateStatefulSet(etcdCluster *v1alpha1.EtcdCluster, sts *appsv1.StatefulSet) {
...
func newContainers(etcdCluster *v1alpha1.EtcdCluster) []corev1.Container {
	return []corev1.Container{
		{
			Name:            "etcd",
			Image:           etcdCluster.Spec.Image,
			...
			Env: []corev1.EnvVar{
				{
					...
					Value: strconv.Itoa(int(*etcdCluster.Spec.Size)),
				},
				{
					Name:  "SET_NAME",
					Value: etcdCluster.Name,
				},
				{
					Name: "POD_IP",
