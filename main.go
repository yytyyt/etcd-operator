...
import (
	...
	"github.com/yytyyt/etcd-operator/controllers"
...
func main() {
	...
	flag.StringVar(&backupImage, "backup-image", defaultBackupImage, "Image for BackUp Etcd Cluster")
	flag.Parse()
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:   "0bf6bb2c.ydzs.io",
	})
	if err != nil {
